...
# Use the functions defined in the previous two exercise to obtain the average letter score for Pietro, Andrew 
# and Lianna and the average letter score of the class.